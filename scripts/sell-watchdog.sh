...
#
# Repair is always "rebuild from origin/main and deploy" — never a patch.
# main is the only ref guaranteed to contain everyone's work.
#
...
What I did     : rebuilt from origin/main and redeployed
Deployed       : $SHA
