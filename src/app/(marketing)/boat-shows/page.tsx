...
export default function BoatShowsPage(){return <EditorialShell eyebrow="Around the world" title="International boat shows." intro="A research directory of major yacht shows and relevant regional events. Each entry separates confirmed information from details that still need checking.">
