...
export default function InsightsPage() {
 ...
 return <EditorialShell eyebrow="The owner’s perspective" title="A clearer view of your next move." intro="Boat selling guides, international show coverage and new boat research from Gray Yachts.">
