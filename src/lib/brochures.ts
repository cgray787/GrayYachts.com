...
export const brochures: Record<string, BrochureContent> = {
  ...
  neverland: {
    ...
    narrative: [
      ...
      "Twelve hundred hours are logged on the Mercury and the boat is offered at $73,000 — below the national average for the model. Maintenance records, full spec sheet, and sea trial available on request.",
    ],
    highlights: [
