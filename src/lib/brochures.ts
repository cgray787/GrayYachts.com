...
export const brochures: Record<string, BrochureContent> = {
  ...
  "blue-pearl": {
    ...
    narrative: [
      ...
      "What sets this particular boat apart is what has been put into her. The current owner has invested over $400,000 rebuilding and upgrading the vessel — effectively every inch of her — sparing no expense along the way. That figure is multiples of the asking price, and it is the reason Blue Pearl presents in a different class from other boats of her vintage. A buyer here is stepping into work already paid for rather than a decade of deferred maintenance.",
      "Power is a pair of Crusader 350hp 7.4L V8 gas engines showing just 919 hours — genuinely low time. The systems work that matters most on a gas boat of this age has been done: new exhaust risers, elbows and Ts, plus updated distributors, plugs and wires. Risers alone are the job that quietly ends a lot of deals; here it is behind you.",
      "Aboard, the layout runs from a full flybridge helm down through a bright salon and dinette, into a galley set below, with a private stateroom and enclosed head forward. The aft cockpit carries a tender and still leaves room to fish or entertain. She is a straightforward, honest cruiser for the San Juans and the Gulf Islands — rebuilt, sorted, and ready to use.",
    ],
    highlights: [
      "Over $400,000 invested by current owner",
      "Rebuilt & upgraded throughout — no expense spared",
